    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/registro_admin").hasAuthority("ROLE_ADMIN")
                .requestMatchers("/admin").hasAuthority("ROLE_ADMIN")
                .requestMatchers("/panel_admin").hasAuthority("ROLE_ADMIN")
                .requestMatchers("/crear_comunidad").hasAuthority("ROLE_ADMIN")
                .requestMatchers("/ver_comunidades").hasAuthority("ROLE_ADMIN")
